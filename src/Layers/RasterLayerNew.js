EsriLeaflet.Layers.RasterLayerNew = L.Class.extend({
  ...
  _addSolrSpatialMarkersGeoJson(params,bounds) {
    //would need to remove previous.
 ...
 var capitalCitiesGeoJsonLayer;
    ...
    // http://gcaseycupp.github.io/LeafletTesting2/data/US_Wellsteapot100.json
